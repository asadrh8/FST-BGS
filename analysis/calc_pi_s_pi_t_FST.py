...
# sys arg 3 = m – between demes
# sys arg 4 = r – between deleterious and neutral site
...
def filter_files(file):
    if file[-5:] == 'trees' and (m in file) and (r in file):
        return True
    return False
...
if __name__ == '__main__':
    ...
    with open(str(sys.argv[5]), 'w') as f:
        ...
        for i in range(0, len(t)):
            writer.writerow([t[i], pi_s[i], pi_t[i], FST[i]])
